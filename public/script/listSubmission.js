    ...
    try {
        ...
        for (const quiz of quizzes) {
            try {
                ...
                submissions.forEach(submission => {
                    ...
                    if (!latestSubmissions[studentID][quiz.quizid] || latestSubmissions[studentID][quiz.quizid].submitid < submitID) {
        ...
        if (studentIDs.length > 0) {
            for (const studentID of studentIDs) {
                ...
                cell1.textContent = latestSubmissions[studentID][Object.keys(latestSubmissions[studentID])[0]].submitid;
